...
def main() -> None:
    ...
    panels = [
        ("燃烧 100%", "burning", 1.0, 117),
        ("不息 100%", "unending", 1.0, 117),
        ("燃烧 2×", "burning", 2.0, 58),
        ("不息 2×", "unending", 2.0, 58),
    ]
    for index, (label, skill, scale, center_y) in enumerate(panels):
        column = index % 2
        row = index // 2
        x = 34 + column * 558
        y = 104 + row * 292
        ...
        qa.composite_center(canvas, frame, (x + 135, y + center_y))
